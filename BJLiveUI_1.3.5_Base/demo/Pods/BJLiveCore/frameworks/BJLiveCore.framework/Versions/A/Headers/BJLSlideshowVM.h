...
/** 设置默认 CDN、CDN 列表 */
+ (void)setDefaultHost:(nullable NSString *)defaultHost
              cdnHosts:(nullable NSArray *)cdnHosts;
...
- (NSArray<BJLSlidePage *> *)slidePagesWithFillSize:(CGSize)fillSize DEPRECATED_MSG_ATTRIBUTE("use `self - allSlidePages` and `BJLSlidePage - pageURLWithSize:scale:fill:format:`");
