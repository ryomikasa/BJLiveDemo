...
- (nullable NSString *)pageURLStringWithPageIndex:(NSInteger)pageIndex
                                         fillSize:(CGSize)size
                                           format:(nullable NSString *)ext DEPRECATED_MSG_ATTRIBUTE("use `BJLAliIMG_aspectFill`, `BJLAliIMG_aspectFit` or `BJLSlidePage - pageURLStringWithSize:scale:fill:format:`");
- (nullable NSString *)pageURLStringWithPageIndex:(NSInteger)pageIndex
                                         fillSize:(CGSize)size
                                            scale:(CGFloat)scale
                                           format:(nullable NSString *)ext DEPRECATED_MSG_ATTRIBUTE("use `BJLAliIMG_aspectFill`, `BJLAliIMG_aspectFit` or `BJLSlidePage - pageURLStringWithSize:scale:fill:format:`");
...
@property (nonatomic, readonly, assign) BOOL isAnimate;
