...
- (nullable UIResponder *)bjl_findResponderWithBlock:(BOOL (NS_NOESCAPE ^)(UIResponder *responder, BOOL *stop))enumerateBlock;
...
@property (nonatomic, readonly, nullable) UIViewController *bjl_topViewController;
