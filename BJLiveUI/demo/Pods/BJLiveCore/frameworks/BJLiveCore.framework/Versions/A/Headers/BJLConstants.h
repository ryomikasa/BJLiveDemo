...
typedef NS_ENUM(NSInteger, BJLRoomType) {
    ...
    BJLRoomType_1toN = 2,
    /** 小班课 */
    BJLRoomType_smallClass = 3,
    /** 新版小班课 */
    BJLRoomType_smallClassV2 = 4,
    /** 双师课 */
    BJLRoomType_doubleTeachersClass = 5,
    /** DEPRECATED */
    BJLRoomType_1toM DEPRECATED_MSG_ATTRIBUTE("use `BJLRoomType_smallClass` instead") = BJLRoomType_smallClass
};
...
typedef NS_ENUM(NSInteger, BJLVideoDefinition) {
    ...
    BJLVideoDefinition_low DEPRECATED_MSG_ATTRIBUTE("use BJLVideoDefinition_std instead") = BJLVideoDefinition_std
};
/** 视频清晰度 - 播放
typedef NS_ENUM(NSInteger, BJLLiveDefinition) {
    // 流畅
    BJLLiveDefinition_low,
    // 标清
    BJLLiveDefinition_std,
    // 高清
    BJLLiveDefinition_high,
    // 超清
    BJLLiveDefinition_super,
    // 720p
    BJLLiveDefinition_720p,
    // 1080p
    BJLLiveDefinition_1080p
}; */

/** 视频清晰度 - 播放 */
typedef NSString * BJLLiveDefinitionKey NS_STRING_ENUM;
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_low;   // 流畅
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_std;   // 标清
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_high;  // 高清
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_super; // 超清
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_720p;  // 720p
FOUNDATION_EXPORT NSKeyValueOperator const BJLLiveDefinitionKey_1080;  // 1080p
